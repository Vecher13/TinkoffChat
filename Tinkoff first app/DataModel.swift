...
var chatList = [ChatModel(name: nil, message: chatWithYakov, date: Date.init(timeIntervalSince1970: 1614889510), online: true, hasUnreadMessages: false),
                ...
                ChatModel(name: "Cris Mass", message: nil, date: nil, online: true, hasUnreadMessages: nil),
                ...
                ChatModel(name: "Herman", message: nil, date: nil, online: true, hasUnreadMessages: nil),
